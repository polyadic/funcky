...
namespace Funcky.Test.Extensions.EnumerableExtensions
{
    public sealed class MinOrNoneTest
    {
        ...
        [Fact]
        public void GivenASequenceOfInt32ValuesMinOrNoneComputesTheMin()
        {
        ...
        [Fact]
        public void GivenASequenceOfOptionInt32ValuesWhereAllValuesAreNoneMinOrNoneComputesNone()
        {
        ...
        public void GivenASequenceOfOptionInt32ValuesMinOrNoneComputesTheMinIgnoringTheNones()
        {
            ...
            FunctionalAssert.IsSome(-1000, numbers.MinOrNone());
            Assert.Equal(-1000, numbers.WhereSelect().Min());
        }
        ...
        [Fact]
        public void GivenASequenceOfInt64ValuesMinOrNoneComputesTheMin()
        {
        ...
        [Fact]
        public void GivenASequenceOfOptionInt64ValuesWhereAllValuesAreNoneMinOrNoneComputesNone()
        {
        ...
        public void GivenASequenceOfOptionInt64ValuesMinOrNoneComputesTheMinIgnoringTheNones()
        {
            ...
            FunctionalAssert.IsSome(-1000L, numbers.MinOrNone());
            Assert.Equal(-1000L, numbers.WhereSelect().Min());
        }
        ...
        public void GivenASequenceOfOptionSinglesMinOrNoneComputesTheMinIgnoringTheNones()
        {
            ...
            Assert.Equal(-1000.45f, numbers.WhereSelect().Min());
        }
        ...
        public void InSequenceOfSinglesWithANegativeInfinityAndNoNaNTheMinReturnsNegativeInfinity()
        {
            ...
            Assert.Equal(float.NegativeInfinity, numbers.WhereSelect().Min());
        }
        ...
        public void GivenASequenceOfSinglesWithAnNaNTheMinReturnsNaN()
        {
            ...
            Assert.Equal(float.NaN, numbers.WhereSelect().Min());
        }
        ...
        public void GivenASequenceOfOptionDoublesMinOrNoneComputesTheMinIgnoringTheNones()
        {
            ...
            Assert.Equal(-1000.45, numbers.WhereSelect().Min());
        }
        ...
        public void InASequenceOfDoublesWithANegativeInfinityAndNoNaNMinReturnsNegativeInfinity()
        {
            ...
            Assert.Equal(double.NegativeInfinity, numbers.WhereSelect().Min());
        }
        ...
        public void GivenASequenceOfDoublesWithAnNaNTheMinReturnsNaN()
        {
            ...
            Assert.Equal(double.NaN, numbers.WhereSelect().Min());
        }
        ...
        public void GivenASequenceOfOptionDecimalsMinOrNoneComputesTheMinIgnoringTheNones()
        {
            ...
            Assert.Equal(-1000.45m, numbers.WhereSelect().Min());
        }
