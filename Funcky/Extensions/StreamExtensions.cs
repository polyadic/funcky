...
namespace Funcky.Extensions
{
    public static class StreamExtensions
    {
        ...
        public static Option<long> GetLengthOrNone(this Stream stream)
            => CatchInvalidOperationException(() => stream.Length);
        ...
        public static Option<int> GetReadTimeoutOrNone(this Stream stream)
            => CatchInvalidOperationException(() => stream.ReadTimeout);
        ...
        public static Option<int> GetWriteTimeoutOrNone(this Stream stream)
            => CatchInvalidOperationException(() => stream.WriteTimeout);

        private static Option<TResult> CatchInvalidOperationException<TResult>(Func<TResult> func)
